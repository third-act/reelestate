/**
 * Mockups i /public/images/mockups/ (gemena filnamn).
 * Statiska URL:er undviker hash-byte vid varje build och följer Vercels ordning: filsystem före SPA-rewrite.
 */
export const homeMockupZigzag = {
  sectionTitle: 'Lika smidigt hemma som på jobbet',
  sectionLead:
    'Appen som samlar nyheter, bokningar, dokument och ärenden – utan att du behöver hoppa runt bland olika system.',
  rows: [
    {
